...
/**
 * Created by pc1 on 13-11-25.
 */
public class JcMD5Util {
    public static void main(String[] args) {
        try {
            System.out.println(JcMD5Util.createMD5("123456", "1234"));
        } catch (Exception e) {
    ...
    public static String createMD5(String input) throws Exception {
        return createMD5CharSet(input, null);
    }
    ...
    public static String createMD5(String input, String salt, String charset) throws Exception {
        if (JcStringUtils.isNotNullOrBlank(salt)) {
            input += salt;
        }
    ...
    public static String createMD5(String input, String salt) throws Exception {
        ...
        String two = createMD5CharSet(input, null);

        for (int i = 0; i < 2; i++) {
            two = createMD5CharSet(input, null);
        }
        return two;
    }

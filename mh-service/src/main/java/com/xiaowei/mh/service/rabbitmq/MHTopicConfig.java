 ...
 */
public class MHTopicConfig {
    //交换机名称
    public final static String EXCHANGE = "mh-Exchanges";
    //路由key
    public final static String ROUTINGKEY_V1 = "mhV1.xiaowei";
    public final static String ROUTINGKEY_V2 = "mhV2.xiaowei";
    //队列名称
    public final static String QUEUE = "queue-mh";
    //是否持久化
     ...
     *       #（井号）：可以匹配多个单词（或者零个）
     */
    public final static String KEY_V1 = "mhV1.#";
    public final static String KEY_V2 = "mhV2.#";
}

package com.xiaowei.mh.web.aspect;

import com.alibaba.fastjson.JSONObject;
import com.xiaowei.mh.common.common.JSONResult;
import com.xiaowei.mh.common.error.BaseReq;
import com.xiaowei.mh.common.error.BizException;
import com.xiaowei.mh.common.error.ErrorEnum;
...
private final static Logger LOGGER=LoggerFactory.getLogger(ServiceRequestAspect.class);
    ...
    @Pointcut("execution(public * com.xiaowei.*.*(..))")

package com.xiaowei.mh.mapper.config;
...
public class DataSourceConfig {
     ...
     */
    private static String MAPPER_PATH = "/com/xiaowei/mh/mapper/**/*.xml";
    private static String TYPE_ALIASES_Package = "com.xiaowei.mh.mapper.dataobject";
    static final String PACKAGE = "com.xiaowei.mh.mapper.mapper";
    @Autowired
